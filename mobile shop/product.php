...
echo "<div class='m-b-10px f-w-b'>Price:</div>";
echo "<h4 class='m-b-30px price-description'>€" . number_format($product->price, 2, '.', ',') . "</h4>";

echo "<div class='m-b-10px f-w-b'>Product description:</div>";
